  ...
  return (
    <div className="flex justify-space-around items-center align-center bg-[#121420] h-[100vh]">
      ...
      <div className="w-[55%] text-white ">
        ...
        <button onClick={getStartedBtn} className="border-2 border-[#48CAE4] w-[307px] m-10 rounded-[50px] h-[44px] hover:text-black hover:bg-white transition duration-300 ease-in-out">Get Started</button>
      </div>
    </div>
  );
};
