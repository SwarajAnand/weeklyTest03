  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-[100%] h-[100vh] bg-[#121420]">
      ...
      <div className="flex justify-center items-center absolute top-32">
        <div className="bg-[#fff] w-[200px] p-2 rounded-3xl mr-10">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col justify-center items-center pt-8">
            <img
              src={outputImage}
              alt="output image"
              className="h-[320px] w-[400px] p-5 rounded-md m-auto shadow-xl  bg-white p-8"
            />
            <button
              className="removeBgButton mt-[55px] bg-[#fff] w-[200px] p-2 rounded-3xl"
